function convertToJSON(value) {
  ...
  console.log(convertToJSON(66)) // => 66
  console.log(typeof convertToJSON(66)) // => string
  console.log(convertToJSON([18, 'Grom', { count: 63443 }])) // => [18,"Grom",{"count":63443}]
  console.log(typeof convertToJSON([12, 'Boom', { count: 63443 }])) // => string
  console.log(convertToJSON({ count: 63443, prop: { 17: 17.9 } })) // => {"count":63443,"prop":{"17":17.9}}
  console.log(typeof convertToJSON({ count: 63443, prop: { 17: 17.9 } })) // => string